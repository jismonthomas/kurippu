...
export default function RegisterForm({ className }) {
    ...
    return (
        <div className={className}>
            <div className="border py-5 lg:py-10 px-7 lg:px-14 rounded-lg shadow-sm">
                    ...
                    <AnimatePresence>
                        {formStatus.error && !isPending ? (
                            <motion.div
                                ...
                                exit={{ opacity: 0, y: -10 }}>
                                <Alert className="mb-5 bg-red-700 text-red-50 border-red-600">
                        ...
                        {formStatus.success && !isPending ? (
                            <motion.div
                                ...
                                animate={{ opacity: 1, y: 0 }}
                                exit={{ opacity: 0, y: -10 }}>
                                <Alert className="mb-5 bg-green-700 text-green-50 border-green-600">
                    ...
                    <Form {...form}>
                        <form
                            ...
                            <div className="space-y-2">
                                <Button
                                    type="submit"
                                    className="w-full mt-5 relative bg-gray-950">
                                    <span
                                ...
                                <Button
                                    type="button"
                                    variant="secondary"
                                    className="w-full border border-gray-950 text-gray-950 bg-transparent"
                                    asChild>
                                    <Link href={`/login`}>
                                        I have an account
                                    </Link>
